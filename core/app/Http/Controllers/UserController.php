    ...
    public function transferOwnBankConfirm(Request $request)
{
    ...
    return redirect()->route('user.dashboard')->with('success', 'Transfert réussi à ' . $receiver->name . '. Montant: ' . $request->amount . ' ' . $gnl->cur . '. Frais: ' . $charge . ' ' . $gnl->cur . '. Nouveau solde: ' . $sender->balance . ' ' . $gnl->cur);
}
