...
Route::get('/send-test-email', function () {
    Mail::raw('This is a test email from Laravel', function ($message) {
        $message->to('zannoharry@gmail.com') 
                ->subject('Test Email');
    });
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin', 'as' => 'admin.'], function () {
    ...
    Route::get('/manual-deposit', 'AdminController@manualDepositForm')->name('manual.deposit.form');
    Route::post('/manual-deposit', 'AdminController@manualDepositSubmit')->name('manual.deposit.submit');
 ...
 /////branch////
    ...
    Route::post('/withdraw/approve/{id}', 'AdminController@withdrawApprove')->name('withdraw.approve');
    Route::post('/withdraw/reject/{id}', 'AdminController@withdrawReject')->name('withdraw.reject');
